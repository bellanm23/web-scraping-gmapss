...
def translate_text(text):
    try:
        ...
        translation = translator.translate(text_fix, dest='en')
        ...
        for field in fields:
            if field == Fields.REVIEWS_PER_RATING:
                ...
                transformed_place['menu_link'] = place['menu']['link'] if 'menu' in place and 'link' in place['menu'] else None
                 ...
                 #Tambahkan blok kondisi baru untuk menerjemahkan teks ke bahasa Inggris
            elif isinstance(place[field], str):
                transformed_place[field] = translate_text(place[field])
                ...
                if Fields.ABOUT in place and place[Fields.ABOUT]:
                    # Jika ABOUT ada dan tidak kosong
                    about_description = place[Fields.ABOUT][0].get('description', '')
                    transformed_place[field] = translate_text(about_description)
                else:
                    transformed_place[field] = ''
